...
export default function HomeLogin() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-yellow-200 to-orange-400">
            <section className="min-h-screen flex flex-col md:flex-row items-center justify-center px-6 gap-16">
                ...
                <div className="text-left bg-gray-200 p-8 rounded-2xl shadow-2xl w-full max-w-md">
                    ...
                    <form className="space-y-4">
                        ...
                        <button
                            ...
                            type="submit"
                            className="w-full bg-orange-500 text-white py-3 rounded-lg font-semibold hover:bg-orange-600 hover:scale-105 transition-all duration-300"
                        >
                            INGRESAR
                        </button>
                    </form>
