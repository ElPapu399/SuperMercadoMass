...
export default function HomeLogin() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-yellow-300 to-orange-600 text-slate-100 flex flex-col justify-between">
            ...
            {/* Cabecera / Logo */}
            <div className="w-full max-w-7xl mx-auto px-5 py-3 flex justify-between items-center z-10 relative">
                <img
                    src={logoMass}
                    alt="Logo MASS"
                    className="h-40 w-auto object-contain hover:scale-105 transition-transform duration-300"
                />
                <span className="text-[10px] sm:text-[13px] font-bold tracking-widest text-slate-200 bg-slate-800/80 px-3.5 py-1.5 rounded-full border border-slate-700/50 uppercase">
                ...
                <div className="lg:col-span-7 text-left space-y-8">
                    <div>
                        ...
                        <h1 className="text-5xl sm:text-6xl md:text-7xl font-black mt-4 tracking-tight leading-none">
                            ...
                            <span
                                className="text-[65px] sm:text-[75px] md:text-[90px] text-transparent bg-clip-text bg-gradient-to-r from-gray-700 to-blue-700"
                                style={{
                                    filter: "drop-shadow(0 3px 3px rgba(255,255,255,1))"
                                }}
                            >
                                {" "}Inventory Control
                            </span>
                        ...
                        <p
                            className="font-bold text-slate-900 text-sm sm:text-base md:text-lg mt-4 m-1.5 leading-relaxed max-w-xl"
                        >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
                        ...
                        <div className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-5 border border-slate-700/40 hover:border-yellow-400/30 transition-all duration-300 hover:translate-y-[-2px] group">
                            ...
                            <h3 className="font-bold text-white text-[21px] mt-4">Control de Existencias</h3>
                        ...
                        <div className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-5 border border-slate-700/40 hover:border-orange-500/30 transition-all duration-300 hover:translate-y-[-2px] group">
                            ...
                            <h3 className="font-bold text-white text-[21px] mt-4">Gestión de Vencimientos</h3>
                            <p className="text-slate-200 text-xs mt-2 leading-relaxed">
                        ...
                        <div className="bg-gray-900/50 backdrop-blur-md rounded-2xl p-5 border border-slate-700/40 hover:border-blue-400/30 transition-all duration-300 hover:translate-y-[-2px] group">
                            ...
                            <h3 className="font-bold text-white text-[21px] mt-4">Auditoría y Reportes</h3>
                            <p className="text-slate-200 text-xs mt-2 leading-relaxed">
                ...
                <div className="lg:col-span-5 flex justify-center">
                    ...
                    >
                        ...
                        <div className="text-center mb-8">
                            <h2 className="text-3xl font-extrabold text-white">Ingreso al Portal</h2>
                            <p className="text-slate-300 text-[13px] mt-1.5">Ingrese sus credenciales de seguridad asignadas</p>
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className={`w-full bg-slate-950/80 border text-slate-100 rounded-xl py-3 px-4 pl-10.5 pr-4 focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all text-sm placeholder:text-slate-600 ${usuarioError ? "border-red-500 focus:ring-red-500" : "border-slate-700"
                                            }`}
                                    />
                                </div>
                                {usuarioError && (
